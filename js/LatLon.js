...
LatLon.prototype.distanceTo = function(point, precision) {
    ...
    var d = r * c;
    return d.toPrecisionFixed(precision) * 1; // Fix * 1
};
...
LatLon.prototype.rhumbDistanceTo = function(point) {
    ...
    // FIX: *1 to cast to number
    return dist.toPrecisionFixed(4) * 1; // 4 sig figs reflects typical 0.3% accuracy of spherical model
};
...
* @return {String} A string representation of number which contains precision significant digits
*/
